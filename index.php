...
<body>
    ...
    <div class="Poke" onmouseup="mouseUp('PokeGame.php')" onmouseout="mouseOut('PB_Highlight')" onmouseover="mouseOver('PB_Highlight')" style="background-image:url('Images/Pokeball.png'); background-size:contain; position:absolute; top:0px; right:30%; width:12%; height:15%; float:right; background-repeat:no-repeat;">

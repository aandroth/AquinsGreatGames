...
<body>
    ...
    <div id="About" onmouseup="mouseUp('iOS_Menu.php')" onmouseover="mouseOver('About')" onmouseout="mouseOut('About')" style="position:relative; top:0px; right:0px; width:513px; height:55px; float:left;">
